...
wallpaper_with_window="${DIONYSUS_WALLPAPER_ACTIVE:-$config_home/hypr/wallpapers/laptop-wallpaper.webp}"
wallpaper_without_window="${DIONYSUS_WALLPAPER_IDLE:-$config_home/hypr/wallpapers/laptop-wallpaper.webp}"
current_wallpaper=""
eww_visible=false
